...
RARITY_CHANCES = {    "regular card": 25,    "rare card": 20,
    "exclusive card": 19,    "epic card": 12,
    "collectible card": 18,    "LIMITED": 5}
PREMIUM_RARITY_CHANCES = {    "regular card": 12,    "rare card": 12,
    "exclusive card": 25,    "epic card": 20,    "collectible card": 25,
    "LIMITED": 10}# 2. Список всех карт.
CARDS = [
